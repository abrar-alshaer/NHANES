...
merge_sub <- merge[,c(1,42,5,6,9,142,219)] #ID, population weights, gender, age, race, EPA intake, BMIs
merge_sub_rmNA <- na.omit(merge_sub)
hist(merge_sub_rmNA$DR1TP205)
plot(merge_sub_rmNA$DR1TP205, merge_sub_rmNA$BMXBMI)
...
#Graphing
# Plot the mean of BMI by EPA quartiles
plotmeans(BMXBMI ~ Quartiles, data = merge_sub_rmNA, frame = TRUE, main = "BMI by EPA - Ages > 18")

# Plot the mean of BMI by EPA quartiles WITHOUT zeros
plotmeans(BMXBMI ~ Quartiles, data = merge_sub_rmNA_z, frame = TRUE, main = "BMI by EPA - Ages > 18", xlab = "EPA Quartiles", ylab = "BMI", p=0.95)
...
stripchart(BMXBMI ~ Quartiles, data = merge_sub_rmNA_z,
           ...
           main = "BMI by EPA - Ages > 18", xlab = "EPA Quartiles", ylab = "BMI")
...
#OUTPUT PLOTS TO FILE - for BMI by EPA Stratifying by Ages
pdf("EPA_BMI_Ages_stats.pdf")
...
p1 <- ggline(ageQ, x = "Quartiles", y = "BMXBMI", xlab = "Quartiles of EPA Intake", ylab = "BMI", add = c("mean_se"), title = "BMI by EPA Ages Q1 (2-13)")
# Create a text
...
p2<- ggline(ageQ, x = "Quartiles", y = "BMXBMI", xlab = "Quartiles of EPA Intake", ylab = "BMI", add = c("mean_se"), title = "BMI by EPA Ages Q2 (14-30)")
# Create a text
grob <- grobTree(textGrob(paste("Kruskal Wallis: ", signif(kruskal.test(BMXBMI ~ Quartiles,  data = ageQ)[[3]], digits = 3)), x=0.1,  y=0.95, hjust=0,
                          gp=gpar(col="red", fontsize=13, fontface="italic")))
# Plot
...
p3 <- ggline(ageQ, x = "Quartiles", y = "BMXBMI", xlab = "Quartiles of EPA Intake", ylab = "BMI", add = c("mean_se"), title = "BMI by EPA Ages Q3 (31-52)")
# Create a text
grob <- grobTree(textGrob(paste("Kruskal Wallis: ", signif(kruskal.test(BMXBMI ~ Quartiles,  data = ageQ)[[3]], digits = 3)), x=0.1,  y=0.95, hjust=0,
                          gp=gpar(col="red", fontsize=13, fontface="italic")))
# Plot
...
p4 <- ggline(ageQ, x = "Quartiles", y = "BMXBMI", xlab = "Quartiles of EPA Intake", ylab = "BMI", add = c("mean_se"), title = "BMI by EPA Ages Q4 (53-79)")
# Create a text
grob <- grobTree(textGrob(paste("Kruskal Wallis: ", signif(kruskal.test(BMXBMI ~ Quartiles,  data = ageQ)[[3]], digits = 3)), x=0.1,  y=0.95, hjust=0,
                          gp=gpar(col="red", fontsize=13, fontface="italic")))
# Plot
...
p1 <- ggline(ageQ, x = "Quartiles", y = "BMXBMI", xlab = "Quartiles of EPA Intake", ylab = "BMI", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "BMI by EPA Ages Q1 (2-13)")
...
p2<- ggline(ageQ, x = "Quartiles", y = "BMXBMI", xlab = "Quartiles of EPA Intake", ylab = "BMI", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "BMI by EPA Ages Q2 (14-30)")
...
p3 <- ggline(ageQ, x = "Quartiles", y = "BMXBMI", xlab = "Quartiles of EPA Intake", ylab = "BMI", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "BMI by EPA Ages Q3 (31-52)")
...
p4 <- ggline(ageQ, x = "Quartiles", y = "BMXBMI", xlab = "Quartiles of EPA Intake", ylab = "BMI", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "BMI by EPA Ages Q4 (53-79)")
...
p5 <- ggerrorplot(ageQ, x = "Quartiles", y = "BMXBMI", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of EPA Intake", ylab = "BMI",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "BMI by EPA", subtitle = "Ages Q1 (2-13)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
...
p6 <- ggerrorplot(ageQ, x = "Quartiles", y = "BMXBMI", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of EPA Intake", ylab = "BMI",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "BMI by EPA", subtitle = "Ages Q2 (14-30)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
...
p7 <- ggerrorplot(ageQ, x = "Quartiles", y = "BMXBMI", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of EPA Intake", ylab = "BMI",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "BMI by EPA", subtitle = "Ages Q3 (31-52)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
...
p8 <- ggerrorplot(ageQ, x = "Quartiles", y = "BMXBMI", 
            desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of EPA Intake", ylab = "BMI",
            color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "BMI by EPA", subtitle = "Ages Q4 (53-79)",
            position = position_dodge(0.3)     # Adjust the space between bars
)
