...
merge_sub <- merge[,c(1,42,5,6,9,142,219,220)] #ID, population weights, gender, age, race, EPA intake, infection info, BMI
merge_sub_rmNA <- na.omit(merge_sub)
...
ggbarplot(df, x = "Quartiles", y = "Freq", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu, pneumonia, ear infection)", label = TRUE, width = 0.5, fill = "Quartiles", color = "Quartiles", palette = c("lightskyblue", "lightblue2", "lightblue3", "lightblue4"), title = "Infection by EPA All Ages")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 100, label.x = 1)      # Add global p-value
...
#plotting by gender
ggbarplot(tal, x = "Quartiles", y = "n", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu, pneumonia, ear infection)", label = TRUE, width = 0.5, fill = "RIAGENDR", color = "RIAGENDR", position = position_dodge(0.9), legend.title = "Gender", palette = "Paired", title = "Infection by EPA All Ages")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
ggbarplot(df_l, x = "Quartiles", y = "Freq", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu, pneumonia, ear infection)", label = TRUE, width = 0.5, fill = "Quartiles", color = "Quartiles", palette = c("lightskyblue", "lightblue2", "lightblue3", "lightblue4"), title = "Infection by EPA All Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
ggbarplot(tal_l, x = "Quartiles", y = "n", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu, pneumonia, ear infection)", label = TRUE, width = 0.5, fill = "RIAGENDR", color = "RIAGENDR", position = position_dodge(0.9), legend.title = "Gender", palette = "Paired", title = "Infection by EPA All Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
