...
#data3 <- nhanes_load_data("DR1TOT_F", "2009-2010", cache = "./nhanes_data", demographics = TRUE, recode = TRUE)
...
merge_sub <- merge[,c(1,42,5,6,9,142,220,221)] #ID, population weights, gender, age, race, EPA intake, infection info, BMI
merge_sub_rmNA <- na.omit(merge_sub)
...
#Half
quantile(merge_sub_rmNA$DR1TP205, prob = c(0.5,1))
...
merge_sub_rmNA$Quartiles <- ifelse(merge_sub_rmNA$DR1TP205 <= quantile(merge_sub_rmNA$DR1TP205, 0.5),1,2)
...
ggbarplot(df, x = "Quartiles", y = "Freq", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu/cold)", label = TRUE, width = 0.5, fill = "Quartiles", color = "Quartiles", palette = c("lightskyblue", "lightblue2", "lightblue3", "lightblue4"), title = "Infection by EPA All Ages")+
...
#plotting by gender
ggbarplot(tal, x = "Quartiles", y = "n", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu/cold)", label = TRUE, width = 0.5, fill = "RIAGENDR", color = "RIAGENDR", position = position_dodge(0.9), legend.title = "Gender", palette = "Paired", title = "Infection by EPA All Ages")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003'), paste('2\n0.006'), paste('3\n0.014'), paste('4\n1.22')))
...
ggbarplot(df_l, x = "Quartiles", y = "Freq", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu/cold)", label = TRUE, width = 0.5, fill = "Quartiles", color = "Quartiles", palette = c("lightskyblue", "lightblue2", "lightblue3", "lightblue4"), title = "Infection by EPA All Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003'), paste('2\n0.006'), paste('3\n0.014'), paste('4\n1.22')))
...
ggbarplot(tal_l, x = "Quartiles", y = "n", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu/cold)", label = TRUE, width = 0.5, fill = "RIAGENDR", color = "RIAGENDR", position = position_dodge(0.9), legend.title = "Gender", palette = "Paired", title = "Infection by EPA All Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003'), paste('2\n0.006'), paste('3\n0.014'), paste('4\n1.22')))
...
ggbarplot(df_g, x = "Quartiles", y = "Freq", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu/cold)", label = TRUE, width = 0.5, fill = "Quartiles", color = "Quartiles", palette = c("lightskyblue", "lightblue2", "lightblue3", "lightblue4"), title = "Infection by EPA All Ages > 18 BMI 30+")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003'), paste('2\n0.006'), paste('3\n0.014'), paste('4\n1.22')))
...
ggbarplot(tal_g, x = "Quartiles", y = "n", xlab = "Quartiles of EPA Intake", ylab = "Frequency of Infection \n (Flu/cold)", label = TRUE, width = 0.5, fill = "RIAGENDR", color = "RIAGENDR", position = position_dodge(0.9), legend.title = "Gender", palette = "Paired", title = "Infection by EPA All Ages > 18 BMI 30+")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003'), paste('2\n0.006'), paste('3\n0.014'), paste('4\n1.22')))
