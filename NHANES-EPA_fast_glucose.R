...
ggerrorplot(merge_sub_rmNA, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Fasting Glucose by EPA All Ages")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 108, label.x = 1)      # Add global p-value
...
#plotting by gender
ggerrorplot(merge_sub_rmNA, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "Fasting Glucose by EPA All Ages")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(aes(group = RIAGENDR), label = "p.signif", hide.ns = TRUE, label.y = c(111, 110, 107, 110))

ggerrorplot(merge_sub_rmNA, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "Fasting Glucose by EPA All Ages")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(aes(group = RIAGENDR), label = "p.format", hide.ns = TRUE, label.y = c(111, 110, 107, 110)) #color palette jco
...
#p <- ggline(merge_sub_rmNA, x = "Quartiles", y = "LBXGLU",
#               #color = "Quartiles", palette = "npg",
#               add = "mean_se",
#               facet.by = "RIAGENDR", short.panel.labs = FALSE, title = "Fasting Glucose by EPA All Ages", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", panel.labs = list(RIAGENDR = c("Female", "Male")))
#p + stat_compare_means(method = "kruskal.test", label.y = 129, label.x = 1)

#To label one facet/panel with text
#ann_text <- data.frame(Quartiles = 4,LBXGLU = 129,lab = "Text", RIAGENDR = factor("Male",levels = c("Female", "Male")))
...
p1 <- ggerrorplot(merge_sub_rmNA_M, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Fasting Glucose by EPA All Ages - Males")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
p2 <- ggerrorplot(merge_sub_rmNA_F, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Fasting Glucose by EPA All Ages - Females")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 111, label.x = 1)+      # Add global p-value
...
ggerrorplot(merge_sub_rmNA_less30, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", title = "Fasting Glucose by EPA Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
ggerrorplot(merge_sub_rmNA_less30, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "Fasting Glucose by EPA All Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
#my_comp3 <- list(c("1", "3"))
p3 <- ggerrorplot(merge_sub_rmNA_less30_M, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Fasting Glucose by EPA Ages > 18 BMI < 30", subtitle = "Males")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 113, label.x = 1)
...
#my_comp4 <- list(c("2", "3"))
p4 <- ggerrorplot(merge_sub_rmNA_less30_F, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Fasting Glucose by EPA Ages > 18 BMI < 30", subtitle = "Females")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 113, label.x = 1)
...
ggerrorplot(merge_sub_rmNA_great30, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", title = "Fasting Glucose by EPA Ages > 18 BMI 30+")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
#plotting by gender (uses Wilcoxon pairwise test like above)
ggerrorplot(merge_sub_rmNA_great30, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "Fasting Glucose by EPA Ages > 18 BMI 30+")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
p5 <- ggerrorplot(merge_sub_rmNA_great30_M, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Fasting Glucose by EPA Ages > 18 BMI 30+", subtitle = "Males")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
#my_comp6 <- list(c("1", "4"))
p6 <- ggerrorplot(merge_sub_rmNA_great30_F, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Fasting Glucose by EPA Ages > 18 BMI 30+", subtitle = "Females")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 129, label.x = 1)
...
# Plot the mean of Fasting Glucose by EPA quartiles
plotmeans(LBXGLU ~ Quartiles, data = merge_sub_rmNA, frame = TRUE, main = "Fasting Glucose by EPA - All Ages")

# Plot the mean of Fasting Glucose by EPA quartiles WITHOUT zeros
plotmeans(LBXGLU ~ Quartiles, data = merge_sub_rmNA_z, frame = TRUE, main = "Fasting Glucose by EPA - Ages > 18", xlab = "EPA Quartiles", ylab = "Fasting Glucose", p=0.95)
...
stripchart(LBXGLU ~ Quartiles, data = merge_sub_rmNA_z,
           ...
           main = "Fasting Glucose by EPA - Ages > 18", xlab = "EPA Quartiles", ylab = "Fasting Glucose")
...
#########Making PDFs##########
#OUTPUT PLOTS TO FILE - for Fasting Glucose by EPA Stratifying by Ages
pdf("EPA_Fasting_Glucose_Ages_stats.pdf")
...
p1 <- ggline(ageQ, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean_se"), title = "Fasting Glucose by EPA", subtitle = "Ages Q1 (12-23)")
# Create a text
...
p2<- ggline(ageQ, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean_se"), title = "Fasting Glucose by EPA", subtitle = "Ages Q2 (24-41)")
# Create a text
grob <- grobTree(textGrob(paste("Kruskal Wallis: ", signif(kruskal.test(LBXGLU ~ Quartiles,  data = ageQ)[[3]], digits = 3)), x=0.1,  y=0.95, hjust=0,
                          gp=gpar(col="red", fontsize=13, fontface="italic")))
# Plot
...
p3 <- ggline(ageQ, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean_se"), title = "Fasting Glucose by EPA", subtitle = "Ages Q3 (42-57)")
# Create a text
grob <- grobTree(textGrob(paste("Kruskal Wallis: ", signif(kruskal.test(LBXGLU ~ Quartiles,  data = ageQ)[[3]], digits = 3)), x=0.1,  y=0.95, hjust=0,
                          gp=gpar(col="red", fontsize=13, fontface="italic")))
# Plot
...
p4 <- ggline(ageQ, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean_se"), title = "Fasting Glucose by EPA", subtitle = "Ages Q4 (58-79)")
# Create a text
grob <- grobTree(textGrob(paste("Kruskal Wallis: ", signif(kruskal.test(LBXGLU ~ Quartiles,  data = ageQ)[[3]], digits = 3)), x=0.1,  y=0.95, hjust=0,
                          gp=gpar(col="red", fontsize=13, fontface="italic")))
# Plot
...
p1 <- ggline(ageQ, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "Fasting Glucose by EPA", subtitle = "Ages Q1 (12-23)")
...
p2<- ggline(ageQ, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "Fasting Glucose by EPA", subtitle = "Ages Q2 (24-41)")
...
p3 <- ggline(ageQ, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "Fasting Glucose by EPA", subtitle = "Ages Q3 (42-57)")
...
p4 <- ggline(ageQ, x = "Quartiles", y = "LBXGLU", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "Fasting Glucose by EPA", subtitle = "Ages Q4 (58-79)")
...
p5 <- ggerrorplot(ageQ, x = "Quartiles", y = "LBXGLU", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "Fasting Glucose by EPA", subtitle = "Ages Q1 (12-23)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
...
p6 <- ggerrorplot(ageQ, x = "Quartiles", y = "LBXGLU", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "Fasting Glucose by EPA", subtitle = "Ages Q2 (24-41)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
...
p7 <- ggerrorplot(ageQ, x = "Quartiles", y = "LBXGLU", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "Fasting Glucose by EPA", subtitle = "Ages Q3 (42-57)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
...
p8 <- ggerrorplot(ageQ, x = "Quartiles", y = "LBXGLU", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of EPA Intake", ylab = "Fasting Glucose (mg/dL)",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "Fasting Glucose by EPA", subtitle = "Ages Q4 (58-79)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
