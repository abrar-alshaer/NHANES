...
ggerrorplot(merge_sub_rmNA, x = "Quartiles", y = "LBXGLT", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "OGTT by DHA All Ages")+
...
ggerrorplot(merge_sub_rmNA, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "OGTT by DHA All Ages")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
...
ggerrorplot(merge_sub_rmNA, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "OGTT by DHA All Ages")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(aes(group = RIAGENDR), label = "p.format", hide.ns = TRUE, label.y = c(120, 117, 121, 125)) #color palette jco
...
#             add = "mean_se",
#             facet.by = "RIAGENDR", short.panel.labs = FALSE, title = "OGTT by DHA All Ages", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", panel.labs = list(RIAGENDR = c("Female", "Male")))
...
p1 <- ggerrorplot(merge_sub_rmNA_M, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "OGTT by DHA All Ages - Males")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 124, label.x = 1)+      # Add global p-value
...
p2 <- ggerrorplot(merge_sub_rmNA_F, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "OGTT by DHA All Ages - Females")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 124, label.x = 1)
...
ggerrorplot(merge_sub_rmNA_less30, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", title = "OGTT by DHA Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
...
#plotting by gender (uses Wilcoxon pairwise test like above)
ggerrorplot(merge_sub_rmNA_less30, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "OGTT by DHA All Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
...
ggerrorplot(merge_sub_rmNA_less30, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "OGTT by DHA All Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(aes(group = RIAGENDR), label = "p.format", hide.ns = TRUE, label.y = c(117, 117, 123, 125)) #color palette jco
...
#my_comp3 <- list(c("2", "4"))
p3 <- ggerrorplot(merge_sub_rmNA_less30_M, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "OGTT by DHA Ages > 18 BMI < 30", subtitle = "Males")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 126, label.x = 1)      # Add global p-value
...
#my_comp4 <- list(c("2", "3"))
p4 <- ggerrorplot(merge_sub_rmNA_less30_F, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "OGTT by DHA Ages > 18 BMI < 30", subtitle = "Females")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 126, label.x = 1)
...
ggerrorplot(merge_sub_rmNA_great30, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", title = "OGTT by DHA Ages > 18 BMI 30+")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
...
#plotting by gender (uses Wilcoxon pairwise test like above)
ggerrorplot(merge_sub_rmNA_great30, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "OGTT by DHA Ages > 18 BMI 30+")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(aes(group = RIAGENDR), label = "p.signif", hide.ns = TRUE, label.y = c(118, 113, 122, 123))
...
ggerrorplot(merge_sub_rmNA_great30, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "OGTT by DHA Ages > 18 BMI 30+")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(aes(group = RIAGENDR), label = "p.format", hide.ns = TRUE, label.y = c(153, 129, 143, 141)) #color palette jco
...
my_comp5 <- list(c("1","2"))
p5 <- ggerrorplot(merge_sub_rmNA_great30_M, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "OGTT by DHA Ages > 18 BMI 30+", subtitle = "Males")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 160, label.x = 1)+
...
#my_comp6 <- list(c("2", "3"))
p6 <- ggerrorplot(merge_sub_rmNA_great30_F, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "OGTT by DHA Ages > 18 BMI 30+", subtitle = "Females")+
  scale_x_discrete(name = '\nQuartiles of DHA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.011\nn = ', n2), paste('3\n0.056\nn = ', n3), paste('4\n4.08\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 160, label.x = 1) #use ..p.adj.. for adjusted p-values
...
#Graphing
# Plot the mean of OGTT by DHA quartiles
plotmeans(LBXGLT ~ Quartiles, data = merge_sub_rmNA, frame = TRUE, main = "OGTT by DHA - All Ages")

# Plot the mean of OGTT by DHA quartiles WITHOUT zeros
plotmeans(LBXGLT ~ Quartiles, data = merge_sub_rmNA_z, frame = TRUE, main = "OGTT by DHA - Ages > 18", xlab = "DHA Quartiles", ylab = "OGTT", p=0.95)
...
stripchart(LBXGLT ~ Quartiles, data = merge_sub_rmNA_z,
           ...
           main = "OGTT by DHA - Ages > 18", xlab = "DHA Quartiles", ylab = "OGTT")
...
########Printing to PDFs############
#OUTPUT PLOTS TO FILE - for OGTT by DHA Stratifying by Ages
pdf("DHA_OGTT_Ages_stats.pdf")
...
p1 <- ggline(ageQ, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean_se"), title = "OGTT by DHA Ages Q1 (12-22)")
# Create a text
...
p2<- ggline(ageQ, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean_se"), title = "OGTT by DHA Ages Q2 (23-39")
# Create a text
grob <- grobTree(textGrob(paste("Kruskal Wallis: ", signif(kruskal.test(LBXGLT ~ Quartiles,  data = ageQ)[[3]], digits = 3)), x=0.1,  y=0.95, hjust=0,
                          gp=gpar(col="red", fontsize=13, fontface="italic")))
# Plot
...
p3 <- ggline(ageQ, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean_se"), title = "OGTT by DHA Ages Q3 (40-55)")
# Create a text
grob <- grobTree(textGrob(paste("Kruskal Wallis: ", signif(kruskal.test(LBXGLT ~ Quartiles,  data = ageQ)[[3]], digits = 3)), x=0.1,  y=0.95, hjust=0,
                          gp=gpar(col="red", fontsize=13, fontface="italic")))
# Plot
...
p4 <- ggline(ageQ, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean_se"), title = "OGTT by DHA Ages Q4 (56-79)")
# Create a text
grob <- grobTree(textGrob(paste("Kruskal Wallis: ", signif(kruskal.test(LBXGLT ~ Quartiles,  data = ageQ)[[3]], digits = 3)), x=0.1,  y=0.95, hjust=0,
                          gp=gpar(col="red", fontsize=13, fontface="italic")))
# Plot
...
p1 <- ggline(ageQ, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "OGTT by DHA Ages Q1 (12-22)")
...
p2<- ggline(ageQ, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "OGTT by DHA Ages Q2 (23-39)")
...
p3 <- ggline(ageQ, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "OGTT by DHA Ages Q3 (40-55)")
...
p4 <- ggline(ageQ, x = "Quartiles", y = "LBXGLT", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)", add = c("mean_se"), color = "RIAGENDR", palette = "jco", legend.title = "Gender", title = "OGTT by DHA Ages Q4 (56-79)")
...
p5 <- ggerrorplot(ageQ, x = "Quartiles", y = "LBXGLT", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "OGTT by DHA", subtitle = "Ages Q1 (12-22)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
...
p6 <- ggerrorplot(ageQ, x = "Quartiles", y = "LBXGLT", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "OGTT by DHA", subtitle = "Ages Q2 (23-39)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
...
p7 <- ggerrorplot(ageQ, x = "Quartiles", y = "LBXGLT", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "OGTT by DHA", subtitle = "Ages Q3 (40-55)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
...
p8 <- ggerrorplot(ageQ, x = "Quartiles", y = "LBXGLT", 
                  desc_stat = "mean_se", error.plot = "errorbar", add = "mean", xlab = "Quartiles of DHA Intake", ylab = "Two Hour Glucose (mg/dl)",
                  color = "RIDRETH3", palette = "jco", legend.title = "Race", title = "OGTT by DHA", subtitle = "Ages Q4 (56-79)",
                  position = position_dodge(0.3)     # Adjust the space between bars
)
