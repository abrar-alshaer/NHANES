...
ggerrorplot(merge_sub_rmNA, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Glycohemoglobin by EPA All Ages")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 5.75, label.x = 1)+      # Add global p-value
...
#plotting by gender
ggerrorplot(merge_sub_rmNA, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "Glycohemoglobin by EPA All Ages")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
ggerrorplot(merge_sub_rmNA, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "Glycohemoglobin by EPA All Ages")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(aes(group = RIAGENDR), label = "p.format", hide.ns = TRUE, label.y = c(5.73, 5.712, 5.62, 5.70)) #color palette jco
...
#               add = "mean_se",
#               facet.by = "RIAGENDR", short.panel.labs = FALSE, title = "Glycohemoglobin by EPA All Ages", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", panel.labs = list(RIAGENDR = c("Female", "Male")))
...
p1 <- ggerrorplot(merge_sub_rmNA_M, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Glycohemoglobin by EPA All Ages - Males")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 5.75, label.x = 1)      # Add global p-value
...
p2 <- ggerrorplot(merge_sub_rmNA_F, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Glycohemoglobin by EPA All Ages - Females")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 5.75, label.x = 1)      # Add global p-value
...
ggerrorplot(merge_sub_rmNA_less30, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", title = "Glycohemoglobin by EPA Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 5.75, label.x = 1)+
  stat_compare_means(comparisons = my_comp1, tip.length = c(0.0005), label = "p.format", hide.ns = TRUE, label.y = c(5.67, 5.712)) #p.format to place actual p-values (uses wilcox.test)

#plotting by gender (uses Wilcoxon pairwise test like above)
ggerrorplot(merge_sub_rmNA_less30, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "Glycohemoglobin by EPA All Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
ggerrorplot(merge_sub_rmNA_less30, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "Glycohemoglobin by EPA All Ages > 18 BMI < 30")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(aes(group = RIAGENDR), label = "p.format", hide.ns = TRUE, label.y = c(5.7,5.7,5.6,5.68)) #color palette jco
...
my_comp3 <- list(c("1", "3"))
p3 <- ggerrorplot(merge_sub_rmNA_less30_M, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Glycohemoglobin by EPA Ages > 18 BMI < 30", subtitle = "Males")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
my_comp4 <- list(c("1","2"), c("1", "3"))
p4 <- ggerrorplot(merge_sub_rmNA_less30_F, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Glycohemoglobin by EPA Ages > 18 BMI < 30", subtitle = "Females")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 5.8, label.x = 1)+
  stat_compare_means(comparisons = my_comp4, tip.length = c(0.001), label = "p.format", hide.ns = TRUE, label.y = c(5.68, 5.73)) #p.format to place actual p-values (uses wilcox.test)
...
ggerrorplot(merge_sub_rmNA_great30, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", title = "Glycohemoglobin by EPA Ages > 18 BMI 30+")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
#plotting by gender (uses Wilcoxon pairwise test like above)
ggerrorplot(merge_sub_rmNA_great30, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", color = "RIAGENDR", palette = "npg", legend.title = "Gender", title = "Glycohemoglobin by EPA Ages > 18 BMI 30+")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
#my_comp5 <- list(c("1", "4"))
p5 <- ggerrorplot(merge_sub_rmNA_great30_M, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Glycohemoglobin by EPA Ages > 18 BMI 30+", subtitle = "Males")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
...
#my_comp6 <- list(c("2", "3"))
p6 <- ggerrorplot(merge_sub_rmNA_great30_F, x = "Quartiles", y = "LBXGH", xlab = "Quartiles of EPA Intake", ylab = "Glycohemoglobin (%)", add = c("mean", "mean_se"), error.plot = "errorbar", palette = "jco", title = "Glycohemoglobin by EPA Ages > 18 BMI 30+", subtitle = "Females")+
  scale_x_discrete(name = '\nQuartiles of EPA Intake (grams)', 
                   breaks = c('1', '2', '3', '4'), 
                   labels = c(paste('1\n0.003\nn =', n1), paste('2\n0.008\nn = ', n2), paste('3\n0.016\nn = ', n3), paste('4\n2.69\nn = ', n4)))+
  stat_compare_means(method = "kruskal.test", label.y = 6.3, label.x = 1)
